      ...
      <div className="relative z-10 max-w-3xl w-full text-center space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-md mx-auto">
            The modern point-of-sale platform for growing businesses. Start free, scale with confidence.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          {/* Primary CTA — goes to /pricing for plan selection */}
          <Button
            size="lg"
            className="h-12 px-8 text-md font-semibold gap-2 transition-all"
        ...
        <div className="pt-12 border-t border-border/40 mt-12">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground/60">
            Made by{" "}
            <Link
              href="https://ucyenyen.dev"
              target="_blank"
              className="text-primary font-bold"
            >
              Bryan Fernando Dinata
            </Link>
          </p>
        </div>
      </div>
